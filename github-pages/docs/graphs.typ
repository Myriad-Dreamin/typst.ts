#import "/contrib/typst/diagram.typ": node, arr, commutative-diagram
  ...
  cetz.canvas({
    ...
    group({
      ...
      group({
        ...
        translate((0, -0.6))
        range(0, 10)
          .zip(("d", "e", "a", "d", "b", "e", "e", "f", "lr", "dr"))
          .map(((t, c)) => {
            let q = (0.1 + t * 0.29, 0)
            let tag = "ref-l2-" + str(t)
            sref-rect(q, tag)
            line("ref-l2-" + str(t) + ".south", "data-" + c + ".north", stroke: flow-stroke)
          })
          .sum()
        let l2-line(t, tag: "root") = line(tag + ".south", "ref-l2-" + str(t) + ".north", stroke: flow-stroke)
        ...
        line("light-doc.south", "text-fff.north", stroke: flow-stroke)
        ...
        group({
          ...
          line("dark-doc.south", "text-000.north", stroke: flow-stroke)
        })
        ...
        group({
          ...
          line("light-doc.south", "white-bg.north", stroke: flow-stroke)
          ...
          line("dark-doc.south", "dark-bg.north", stroke: flow-stroke)
        })
      })
    })
