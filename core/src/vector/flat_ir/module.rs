...
pub type RefItemMapSync = chashmap::CHashMap<Fingerprint, (u64, FlatSvgItem)>;
...
pub struct ModuleBuilderImpl<const ENABLE_REF_CNT: bool = false> {
    ...
    pub cache_items: chashmap::CHashMap<Fingerprint, (u64, Fingerprint, FlatSvgItem)>,
    pub items: chashmap::CHashMap<Fingerprint, (u64, FlatSvgItem)>,
