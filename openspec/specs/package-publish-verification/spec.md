# package-publish-verification Specification

## Purpose
Defines the manual verification workflow for workspace npm packages before live publish.
...
- **THEN** the workflow does not attempt the generic workspace package dry-run publish step for that package
