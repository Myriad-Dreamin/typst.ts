...
pub const STD_TEST_FILES: &[(&str, &str)] = &[
    ("bugs", "1597-cite-footnote_00"),
    ("bugs", "2044-invalid-parsed-ident_00"),
    ("bugs", "2105-linebreak-tofu_00"),
    ("bugs", "2650-cjk-latin-spacing-meta_00"),
    ("bugs", "2821-missing-fields_00"),
    ("bugs", "2902-gradient-oklch-panic_00"),
    ("bugs", "2902-gradient-oklch-panic_01"),
    ("bugs", "args-sink_00"),
    ...
    ("bugs", "label-fields-dict_00"),
    ("bugs", "label-fields-dict_01"),
    ("bugs", "label-fields-dict_02"),
    ...
    ("layout", "grid-rtl_00"),
    ("layout", "grid-rtl_01"),
    ("layout", "grid-styling_00"),
    ("layout", "grid-styling_01"),
    ("layout", "grid-styling_02"),
    ("layout", "grid-styling_03"),
    ("layout", "hide_00"),
    ...
    ("layout", "list_07"),
    ("layout", "list_08"),
    ("layout", "out-of-flow-in-block_00"),
    ("layout", "out-of-flow-in-block_01"),
    ("layout", "out-of-flow-in-block_02"),
    ("layout", "out-of-flow-in-block_03"),
    ("layout", "out-of-flow-in-block_04"),
    ("layout", "out-of-flow-in-block_05"),
    ("layout", "pad_00"),
    ("layout", "pad_01"),
    ("layout", "pad_02"),
    ("layout", "pad_03"),
    ...
    ("layout", "terms_05"),
    ("layout", "terms_06"),
    ("layout", "transform-layout_00"),
    ("layout", "transform-layout_01"),
    ("layout", "transform-layout_02"),
    ("layout", "transform-layout_03"),
    ("layout", "transform_00"),
    ("layout", "transform_01"),
    ("layout", "transform_02"),
    ("layout", "transform_03"),
    ...
    ("visualize", "gradient-hue-rotation_00"),
    ("visualize", "gradient-hue-rotation_01"),
    ("visualize", "gradient-hue-rotation_02"),
    ("visualize", "gradient-hue-rotation_03"),
    ("visualize", "gradient-hue-rotation_04"),
    ("visualize", "gradient-hue-rotation_05"),
    ("visualize", "gradient-hue-rotation_06"),
    ("visualize", "gradient-hue-rotation_07"),
    ...
    ("visualize", "pattern-simple_00"),
    ("visualize", "pattern-simple_01"),
    ("visualize", "pattern-small_00"),
    ("visualize", "pattern-small_01"),
