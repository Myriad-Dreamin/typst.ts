...
impl NodeCompiler {
    ...
    #[napi(ts_args_type = "compiledOrBy: NodeTypstPagedDocument | CompileDocArgs, args: QueryDocArgs")]
    pub fn query(
        &mut self,
        opts: MayCompileOpts,
        args: QueryDocArgs,
    ...
    pub fn may_compile(&mut self, opts: MayCompileOpts) -> Result<NodeTypstPagedDocument, NodeError> {
        Ok(match opts {
    ...
    #[napi(ts_args_type = "compiledOrBy: NodeTypstPagedDocument | CompileDocArgs, opts?: RenderPdfOpts")]
    #[cfg(feature = "pdf")]
    pub fn pdf(
        &mut self,
...
impl Exporter<TypstPagedDocument, String> for PlainSvgExporter {
    fn export(&self, _world: &dyn TypstWorld, output: Arc<TypstPagedDocument>) -> SourceResult<String> {
