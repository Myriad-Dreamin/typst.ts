...
#book-meta(
  ...
  summary: [
    ...
    - #chapter("guide/compilers.typ", section: "2")[Compilers]
      ...
      - #chapter("guide/compiler/service.typ", section: "2.2")[Compiler in Rust]
      - #chapter("guide/compiler/node.typ", section: "2.3")[Compiler in Node.js]
      - #chapter("guide/compiler/bindings.typ", section: "2.3")[Compiler in Wasm (Web)]
    - #chapter("guide/renderers.typ", section: "3")[Renderers]
      ...
      - #chapter("guide/renderer/node.typ", section: "3.2")[Node.js Library]
      - #chapter("guide/renderer/react.typ", section: "3.3")[React Library]
      - #chapter("guide/renderer/angular.typ", section: "3.4")[Angular Library]
      - #chapter("guide/renderer/vue3.typ", section: "3.5")[Vue3 Library]
      - #chapter("guide/renderer/hexo.typ", section: "3.6")[Hexo Plugin]
