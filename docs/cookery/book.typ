...
#book-meta(
  ...
  summary: [
    ...
    - #chapter("guide/renderers.typ")[Renderers]
      ...
      - #chapter("guide/renderer/react.typ")[Renderer in React]
      - #chapter("guide/renderer/solid.typ")[Renderer in Solid]
      - #chapter("guide/renderer/angular.typ")[Renderer in Angular]
      - #chapter("guide/renderer/vue3.typ")[Renderer in Vue3]
