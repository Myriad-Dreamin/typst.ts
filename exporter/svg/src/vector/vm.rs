...
pub trait RenderVm<'s> {
    ...
    fn render_transformed(&'s mut self, transformed: &ir::TransformedItem) -> Self::Resultant {
...
impl<'s, 'm: 's, 't: 's, Feat: ExportFeature + 's> RenderVm<'s> for SvgRenderTask<'m, 't, Feat> {
